...
/**
 * Test case for class \DW\Trainingsplatz\Domain\Model\Sport.
 *
 * @copyright Copyright belongs to the respective authors
 * @license http://www.gnu.org/licenses/gpl.html GNU General Public License, version 3 or later
 *
 */
class SportTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	/**
	...
	protected function setUp() {
		$this->subject = new \DW\Trainingsplatz\Domain\Model\Sport();
	}
